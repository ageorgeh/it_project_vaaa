  ...
  return (
        ...
        className="fixed inset-0 bg-bgDark bg-opacity-40 backdrop-blur-sm flex justify-center items-center">
            <div className ="bg-bgLight p-5 rounded">
                ...
                <button type="submit" onClick={deleteBook} className="ml-10 text-font bg-buttonNeutral hover:bg-buttonNeutralHover font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center">Yes</button>
